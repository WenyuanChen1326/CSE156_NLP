...
class Sampler:
    ...
    def sample_sentence(self, prefix = [], max_length = 50):
...
if __name__ == "__main__":
    ...
    trigram = Trigram(unigram, laplace=0.0001)
    trigram.fit_corpus(corpus)
    print(unigram.model)
    # sampler = Sampler(unigram)
    # for i in range(10):
    #     print(i, ":", " ".join(str(x) for x in sampler.sample_sentence(["sam"])))
